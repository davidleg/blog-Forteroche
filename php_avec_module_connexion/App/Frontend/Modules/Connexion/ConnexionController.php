...
class ConnexionController extends BackController
{
  ...
  use \DLSite\ClavierVirtuor; 
	...
	public function executeConnectConnexionFrontend(HTTPRequest $request)
   { 
				...
				{ 	
					...
					if (  password_verify( $password, $userArray["password"] ) ) {
						...
						if ( true == $userArray["status"] )  {
							...
							$this->app->httpResponse()->noCacheRedirect('/connection.html');
						}	
					}
   ...
   /* deconnection du user, pas de prise ne compte erreur sauf trigger */
    public function executeOffConnexionFrontend(HTTPRequest $request)
   {
    ...
    /* si le user rentre son adresse mail pour avoir un nouveau password */
     public function executeNouveauPassConnexionFrontend(HTTPRequest $request)
    {
