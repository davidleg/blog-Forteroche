<form action="" method="post">
  <p>
    ...
    <label>Titre</label><input type="text" name="titre" value="<?= isset($news) ? htmlspecialchars ($news['titre']) : '' ?>" /><br />
    
    <?= isset($erreurs) && in_array(\Entity\News::CONTENU_INVALIDE, $erreurs) ? 'Le contenu est invalide.<br />' : '' ?>
    <label>Contenu</label><textarea rows="8" cols="60" name="contenu"><?= isset($news) ? htmlspecialchars ($news['contenu']) : '' ?></textarea><br />
<?php
